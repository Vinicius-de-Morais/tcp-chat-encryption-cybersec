...
use crate::{
    ciphers::des::bit::{Bit, Bitwise, ShiftLeft, StringBit, ToBitVec},
    ciphers::des::tables::{INITIAL_PERMUTATION_TABLE, KEY_SHIFT, PC1, PC2, RE_EXPANSION_TABLE},
};
...
impl DesAlgo {
    ...
    fn sbox(input: &Vec<Bit>) {
        ...
        for i in 0..8 {
            ...
            // let row_no = group.and(&0b100000u8.to_bit_vec());
        }
    }
...
#[cfg(test)]
mod tests {
    use crate::ciphers::des::bit::{explode_bitstring, ToBitVec};
